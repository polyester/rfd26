...
from rfd26.interfaces import IBrowserLayer
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-rfd26:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-rfd26:initial")
        transaction.commit()
    app._p_jar.sync()
