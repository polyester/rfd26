...
2. Go to your repository at [polyester/rfd26](https://github.com/polyester/rfd26).
...
- [Backend Tests Workflow](https://github.com/polyester/rfd26/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/polyester/rfd26/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/polyester/rfd26-backend`) and Frontend (`ghcr.io/polyester/rfd26-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of rozefilmdagen.nl](https://github.com/polyester/rfd26/actions/workflows/manual-deploy.yml).
