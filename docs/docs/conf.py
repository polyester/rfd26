...
# rfd26 build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/polyester/rfd26/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/polyester/rfd26",
    ...
    "repository_url": "https://github.com/polyester/rfd26",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/polyester/rfd26/edit/main/docs/",
# }
...
ogp_site_name = "rfd26 Documentation"
ogp_type = "website"
...
htmlhelp_basename = "rfd26Documentation"
