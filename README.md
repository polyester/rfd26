...
- Accessible at [http://rfd26.localhost](http://rfd26.localhost) 🌐
...
- **backend**: Houses the API and Plone installation, utilizing pip instead of buildout, and includes a policy package named rfd26.
...
Generated using [Cookieplone (0.9.10)](https://github.com/plone/cookieplone) and [cookieplone-templates (96574af)](https://github.com/plone/cookieplone-templates/commit/96574af4136cae375cc74be36daed12df6ed6f82) on 2025-12-06 16:33:36.441971. A special thanks to all contributors and supporters!
